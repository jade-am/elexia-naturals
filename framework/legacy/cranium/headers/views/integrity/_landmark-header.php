...
<?php if ( is_home() && x_get_option( 'x_integrity_blog_header_enable' ) == '1' ) : ?>
  ...
  <header class="x-header-landmark x-container max width">
    <img class="p-absolute a-bottom a-left" src="<?php echo get_stylesheet_directory_uri(); ?>/images/olive-1.png"  style="left: -15px; bottom: -50px;" />  
    ...
    <img class="p-absolute a-top a-right" src="<?php echo get_stylesheet_directory_uri(); ?>/images/argan-1.png" style="top: -75px; right: -75px;" />
...
<?php elseif ( x_is_product_category() ) : ?>
  ...
  <header class="x-header-landmark x-container max width">
    <img class="p-absolute a-top a-left" src="<?php echo get_stylesheet_directory_uri(); ?>/images/landmark-1.png"  style="top: -25px; left: -25px;" />  
        <div class="x-container max width">
            <h1 class="h-landmark"><span><?php echo $title ?></span></h1>
            <!--<p class="p-landmark-sub"><span><?php echo $subtitle ?></span></p>-->
        </div>
    <img class="p-absolute a-bottom a-right" src="<?php echo get_stylesheet_directory_uri(); ?>/images/landmark-2.png" />    
  </header>
